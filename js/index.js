...
/***/ function(module, exports, __webpack_require__) {
	...
	var _randomTransform = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function generateStar(_ref) {
	  ...
	  setTimeout(function (_) {
	    s.style.transform = 'translate(' + r() * 800 + 'px,' + r() * 800 + 'px)';
	    s.style.opacity = 0.3;
	  }, 300);
...
/***/ function(module, exports) {
	...
	var container = document.querySelector('#intros');
	var DAY = 1000 * 60 * 60 * 24;
	
	var lastIntro = container.querySelector('.intro');
	var isDay = false;
	var nowTime = new Date();
	
	var dayScripts = ['I waked up at 5:30am today, noise outside.', 'Felt sleepy after lunch, so I had a nap.', 'I didn\'t talk to anyone this day.', 'Trying to figure out this stuff, it looks like a maze.'];
	var nightScripts = ['I work at night if needed, won\'t be too late.', 'I\'ll go to bed early to catch up on sleep.', 'I like sleeping, but not when I got an insomnia.', 'They make noise at night this time.'];
	...
	function getText(isDay) {
	  var texts = scripts[isDay ? 'day' : 'night'];
	  var index = Math.random() * texts.length | 0;
	  return texts[index];
	}
	
	function createIntro(_ref) {
	  var isDay = _ref.isDay;
	  var text = _ref.text;
	  var date = _ref.date;
	
	  var fragment = document.createElement('div');
	  fragment.innerHTML = lastIntro.outerHTML;
	  var newIntro = fragment.children[0];
	  newIntro.querySelector('time').textContent = date.toLocaleDateString();
	  newIntro.querySelector('.daynight').textContent = isDay ? 'Day' : 'Night';
